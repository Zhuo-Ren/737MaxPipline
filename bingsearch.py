...
def searchPeriod(period, howManyNewsOneDay=5, fiddler=None):
    # 起止日期（截止日期当天不搜）
    startDate = datetime3.date(period[0], period[1], period[2])
    endDate = datetime3.date(period[3], period[4], period[5])
    # 参数合理性检查
    pass
    ...
    while curDate != endDate:
        # 爬取当日新闻
        searchOndDay(curDate, howManyNewsOneDay, fiddler=fiddler)
        # curDate++
